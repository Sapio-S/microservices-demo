...
5. Access the web frontend through your browser
    ...
    - **Docker For Desktop** should automatically provide the frontend at http://10.0.0.51:80

    - **Kind** does not provision an IP address for the service.
      You must run a port-forwarding process to access the frontend at http://10.0.0.51:8080:
