...
class InfluxDBExporter(base_exporter.Exporter):
    ...
    def __init__(
        ...
        # 可以在这里一直挂着client吗？？
        self.client = InfluxDBClient(url="http://10.0.0.51:8086", token="nMbCj1HHoEV5UTcZBBrtm6kkQ4xzlK8I0EfRrZO2i6ngr3mBB4y0XLUQvBdxTZCnHDoHZQgaNRGbhfSZ9A76fQ==", org="MSRA")
