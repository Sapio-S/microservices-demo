...
request = function()
  local index_ratio         = {{index_ratio}}
  local setCurrency_ratio   = {{setCurrency_ratio}}
  local browseProduct_ratio = {{browseProduct_ratio}}
  local viewCart_ratio      = {{viewCart_ratio}}
  local add2cart_ratio      = {{add2cart_ratio}}
